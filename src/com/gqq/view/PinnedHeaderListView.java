 ...
 * header can be pushed up and dissolved as needed. 一种有头的ListView，头可以需要，也可不需要
 */
public class PinnedHeaderListView extends ListView {
	...
	// 加一个变量，用来判断adapter的属性。到底是CityListAdapter还是CityListSimAdapter。
	...
	public void setAdapter(ListAdapter adapter) {
		...
		if (isPinnerHeaderAdapter())
			mAdapter = (PinnedHeaderAdapter) adapter;
	}

	public boolean isPinnerHeaderAdapter() {
		return adapter instanceof PinnedHeaderAdapter;
	}
